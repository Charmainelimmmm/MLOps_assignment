...
model = load_model('Final IForest Model1')
# model = pickle.load(open('Final IForest Model'))
...
def predict():
    ...
    return render_template('home.html', pred='Anomaly Detected {}'.format(prediction_anomaly))
